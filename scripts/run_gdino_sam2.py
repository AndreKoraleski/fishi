"""Run Grounded SAM 2 over every preprocessing on a WoodScape split, saving one report per cell.

    uv run python scripts/run_gdino_sam2.py --data-dir data --metrics-dir metrics --cache-dir cache
